...
export const DICT: Record<string, Entry> = {
  ...
  roleLabelFranchise: { ru: "Франчайзи (МПП)", bg: "Франчайз (МПП)" },
  ...
  navCohorts: { ru: "Когортный анализ", bg: "Кохортен анализ" },
  navCohortsDesc: {
    ru: "Кто пришёл по какой рекламе и сколько принёс денег с тех пор",
    bg: "Кой е дошъл от коя реклама и колко пари е донесъл оттогава",
  },
  ...
  noticeNoCourseYet: {
    ru: "Курс и/или поток ещё не выбраны — карточка участницы ещё не создана.",
    bg: "Курсът и/или потокът все още не са избрани — картата на участничка все още не е създадена.",
  },
  btnPickCourse: { ru: "Выбрать курс", bg: "Избери курс" },
  hintCohortRequired: {
    ru: "Для этого курса нужно выбрать поток.",
    bg: "За този курс трябва да изберете поток.",
  },
  ...
  // "Когорты" (round 27) — cohort-by-first-touch-campaign report.
  errLoadCohortsFailed: { ru: "Не удалось загрузить когорты", bg: "Кохортите не бяха заредени" },
  cohortHint: {
    ru: "Каждый контакт попадает в свою когорту один раз — по тому источнику/кампании, которая привела его в самый первый раз, даже если позже он придёт снова по другой рекламе.",
    bg: "Всеки контакт попада в своята кохорта веднъж — по източника/кампанията, довели го за пръв път, дори ако по-късно дойде отново по друга реклама.",
  },
  cohortAllTime: { ru: "Всё время", bg: "Цялото време" },
  cohortColPeriod: { ru: "Период", bg: "Период" },
  cohortColSource: { ru: "Источник / кампания", bg: "Източник / кампания" },
  cohortColContacts: { ru: "Контактов", bg: "Контакти" },
  cohortColPaid: { ru: "Купили", bg: "Купили" },
  cohortColConversion: { ru: "Конверсия", bg: "Конверсия" },
  cohortColRevenue: { ru: "Выручка всего", bg: "Приходи общо" },
  cohortNoSource: { ru: "Без источника", bg: "Без източник" },
  cohortEmpty: {
    ru: "Пока нет ни одного контакта с известной датой первого касания.",
    bg: "Все още няма нито един контакт с известна дата на първия контакт.",
  },
  // Round 28 continued (16 сен 2026) — two summary charts requested alongside
  ...
  btnMoveToCohort: { ru: "Перенести на другой поток", bg: "Премести в друг поток" },
  ...
  fieldClubLoginPassword: { ru: "Пароль от логина клуба", bg: "Парола за входа на клуба" },
  fieldClubLoginPasswordHint: {
    ru: "Пароль нигде не хранится в CRM — только в системе входа. Если партнёр его забыл, сбросьте новый прямо здесь.",
    bg: "Паролата не се съхранява никъде в CRM — само в системата за вход. Ако партньорът я е забравил, генерирайте нова тук.",
  },
  btnResetPassword: { ru: "Сбросить пароль", bg: "Нулиране на парола" },
  confirmResetPassword: {
    ru: "Старый пароль перестанет работать сразу. Показать новый ещё раз будет нельзя — обязательно передайте его партнёру сейчас.",
    bg: "Старата парола веднага спира да работи. Новата няма да може да се покаже отново — предайте я на партньора веднага.",
  },
  btnResetPasswordConfirm: { ru: "Да, сбросить", bg: "Да, нулирай" },
  resetPasswordShownOnceHint: {
    ru: "Пароль показан один раз и больше нигде не сохранён — если закроете это окно, посмотреть его снова будет нельзя (только сбросить ещё раз).",
    bg: "Паролата е показана веднъж и не се съхранява никъде — ако затворите прозореца, няма да можете да я видите отново (само да я нулирате пак).",
  },
  ...
  errHqOnlyResetPassword: { ru: "Сбрасывать пароли может только HQ", bg: "Пароли може да нулира само централният офис" },
  errNoLoginForClub: { ru: "У этого клуба ещё нет логина", bg: "Този клуб все още няма вход" },
  ...
  teamAccessSubtitle: {
    ru: "Логины для сотрудников, которым не нужен полный доступ HQ — от просмотра сети (как у таргетолога) до работы только с базой Франчайзи (как у МПП).",
    bg: "Входове за служители, на които не е нужен пълен HQ достъп — от преглед на мрежата (както таргетолога) до работа само с базата Франчайзи.",
  },
  viewerAccessSubtitle: {
    ru: "Для сотрудников вроде таргетолога — видят все города сети во всех вкладках, но не могут ничего создавать, менять или удалять.",
    bg: "За служители като таргетолог — виждат всички градове от мрежата във всички раздели, но не могат да създават, редактират или изтриват нищо.",
  },
  btnAddViewer: { ru: "Добавить доступ", bg: "Добавяне на достъп" },
  emptyNoViewers: { ru: "Пока нет ни одного такого доступа", bg: "Все още няма такъв достъп" },
  headingAddViewer: { ru: "Новый доступ команды", bg: "Нов достъп на екипа" },
  fieldViewerName: { ru: "Имя", bg: "Име" },
  fieldAccessType: { ru: "Тип доступа", bg: "Тип достъп" },
  colAccessType: { ru: "Тип доступа", bg: "Тип достъп" },
  accessTypeNetworkViewLabel: {
    ru: "Просмотр по сети клубов (как у таргетолога)",
    bg: "Преглед на мрежата от клубове (както таргетолога)",
  },
  accessTypeNetworkAndFranchiseViewLabel: {
    ru: "Просмотр по сети клубов + по Франчайзи",
    bg: "Преглед на мрежата от клубове + Франчайзи",
  },
  accessTypeFranchiseEditLabel: {
    ru: "Работа только с базой Франчайзи (МПП)",
    bg: "Работа само с базата Франчайзи",
  },
  headingViewerCreated: { ru: "Доступ создан", bg: "Достъпът е създаден" },
  confirmDeleteViewer: { ru: "Отозвать доступ насовсем? Логин перестанет работать.", bg: "Да се отнеме ли достъпът напълно? Входът ще спре да работи." },
